...
# ==============================================================================
# 🔥 ULTRA-FAST NON-BLOCKING ADSTERRA CORE
# ==============================================================================
st.markdown("""
    <div style="border: 1px dashed #10B981; background-color: rgba(16, 185, 129, 0.05); padding: 8px; text-align: center; border-radius: 4px; margin-bottom: 10px;">
        <span style="color: #10B981; font-size: 9px; letter-spacing: 2px; font-weight: bold;">📢 SPONSORED AD CLUSTER</span>
    </div>
""", unsafe_allow_html=True)

# Optimization: Using requestIdleCallback for Zero-Impact Loading
components.html("""
    <div id="ad-container" style="display:flex; justify-content:center; width:100%; min-height:90px;"></div>
    <script>
